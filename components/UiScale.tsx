...
export default function UiScale() {
  ...
  return (
    <div title="Adjust UI size — click % for auto-fit" style={{ position: 'fixed', bottom: 14, right: 14, zIndex: 99999, display: 'flex', alignItems: 'center', gap: 4, background: TK.surface, border: `1px solid ${TK.brandEdge}`, borderRadius: 99, padding: '4px 6px', boxShadow: '0 4px 14px rgba(37,99,235,.18)', fontFamily: '"DM Sans","Segoe UI",sans-serif' }}>
