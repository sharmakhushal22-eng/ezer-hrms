-- =====================================================================
-- 066_pms_module.sql — delivered by Tushar as "055_pms_module.sql" (correct
-- for his branch, whose last migration was 054). This branch had already
-- reached 065 by the time this landed (RMS + the TDS engine), and 055-057
-- are taken here by an old, already-rolled-back RMS attempt — so renumbered
-- 055→066, 056→067, 057→068. No content changed, only the filename.
--
-- Run 066, then 067 (067 alters a table 066 creates — order matters, see
-- 067's own header). 068 is not a migration; work through it in blocks.
-- =====================================================================
