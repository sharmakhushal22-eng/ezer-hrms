...
const nav = [
  ...
  { icon: '📆', label: 'Holidays & Week-off', href: '/dashboard/holidays' },
  { icon: '📋', label: 'Statutory Leave', href: '/dashboard/statutory-leave' },
  { icon: '🌴', label: 'Leave Config', href: '/dashboard/leave-upload' },
  ...
  { icon: '🔐', label: 'Roles & Permissions', href: '/dashboard/roles' },
