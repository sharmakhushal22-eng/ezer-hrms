...
// from the same place. Home has no module — anybody who can reach the dashboard at all
// may see the landing page.
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  // The door. Nobody signed in goes to the login page; somebody signed in with no admin
  // module at all goes back to their own portal rather than staring at an empty sidebar.
  useEffect(() => {
    if (loading) return
    // The answer never arrived — a timed-out request, say. Somebody holding a token is
    // not thrown out because of that; they stay, unenforced.
